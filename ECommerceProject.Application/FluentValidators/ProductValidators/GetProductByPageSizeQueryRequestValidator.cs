...
{
    public class GetProductByPageSizeQueryRequestValidator:AbstractValidator<GetProductByPageSizeRequest>
    {
        public GetProductByPageSizeQueryRequestValidator()
        {
            ...
            RuleFor(x => x.Size+1).GreaterThan(0).WithMessage("Sayfa boyutu 0 dan büyük olmalıdır").NotEmpty().WithMessage("Sayfa sayısı boş olamaz.").Must(BeValidPageCount).WithMessage("Sayfa sayısı bir tam sayı olmalıdır.");
        }
